...
<section class="ac-block ac-testimonials-slider"
    ...
    aria-roledescription="<?php esc_attr_e('carousel', 'alpacode'); ?>"
    aria-label="<?php esc_attr_e('Testimonials', 'alpacode'); ?>">
    ...
    <div class="ac-testimonials-slider__container">
        ...
        <div class="ac-testimonials-slider__track"
            ...
            ?>
                <blockquote class="ac-testimonials-slider__slide<?php echo $index === 0 ? ' ac-testimonials-slider__slide--active' : ''; ?>"
                    ...
                    role="group"
                    aria-roledescription="<?php esc_attr_e('slide', 'alpacode'); ?>"
                    aria-label="<?php echo esc_attr(sprintf(__('%d of %d', 'alpacode'), $index + 1, count($items))); ?>">
        ...
        <div class="ac-testimonials-slider__controls">
            <button class="ac-testimonials-slider__arrow ac-testimonials-slider__arrow--prev"
                aria-label="<?php esc_attr_e('Previous testimonial', 'alpacode'); ?>"
            ...
            <div class="ac-testimonials-slider__dots" role="tablist" aria-label="<?php esc_attr_e('Testimonial navigation', 'alpacode'); ?>">
                <?php for ($i = 0; $i < count($items); $i++) : ?>
                    <button class="ac-testimonials-slider__dot<?php echo $i === 0 ? ' ac-testimonials-slider__dot--active' : ''; ?>"
                        role="tab"
                        aria-label="<?php echo esc_attr(sprintf(__('Testimonial %d', 'alpacode'), $i + 1)); ?>"
            ...
            <button class="ac-testimonials-slider__arrow ac-testimonials-slider__arrow--next"
                aria-label="<?php esc_attr_e('Next testimonial', 'alpacode'); ?>"
