(function (wp) {
    ...
    registerBlockType('alpacode/services-grid', {
        edit: function (props) {
            ...
            return el(Fragment, null,
                ...
                el('div', { className: 'ac-editor-placeholder' },
                    ...
                    el('div', { className: 'ac-editor-placeholder__title' }, 'Services Grid'),
                    el('div', { className: 'ac-editor-placeholder__text' },
                        items.length + ' items · ' + attributes.columns + ' columns'
                    )
                )
            );
        },
